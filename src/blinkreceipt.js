...
window.BlinkReceipt = {
    ...
    /**
     * This callback is invoked when the primary action button is clicked on. In mobile-scanning mode, it toggles between the "camera shutter" and "add frame" functions, while in "static" file-upload mode, it has the "add image" function. Regardless of function, this callback is invoked when this button is clicked on.
     */
    ...
    /**
     * This callback is invoked when the plus-sign button is clicked on, to sideline the previously-captured frame and prepare the interface to receive another "click". You may override this in your instance to customize the display of the captured frame(s) and related user interface.
     */
    ...
    /**
     * This callback is invoked after a scan and after we’ve considered a number of frames from the video stream and chosen the best (winning) one. You may override this in your instance to customize the display of the captured frame and related user interface.
     *
    ...
    /**
     * This callback is invoked in "static" scanning mode once the user has selected an image and it has loaded. It is specific to the input tag of type="file" with id="brjs-inputImage", which is auto-generated by the core (native) code.
     */
